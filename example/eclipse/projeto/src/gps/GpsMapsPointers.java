...
public class GpsMapsPointers extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
		...
		reference = FirebaseUtil.getInstance().getFirebaseDatabase().getReference("aedespointss");
		...
		reference = FirebaseUtil.getInstance().getFirebaseDatabase().getReference("casos");
        reference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot msgSnapshot: dataSnapshot.getChildren()) {
