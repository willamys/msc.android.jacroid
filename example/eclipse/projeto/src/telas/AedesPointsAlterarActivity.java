...
public class AedesPointsAlterarActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		reference = FirebaseUtil.getInstance().getFirebaseDatabase().getReference().child(AEDESPOINTSS_CHILD).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(valor);
