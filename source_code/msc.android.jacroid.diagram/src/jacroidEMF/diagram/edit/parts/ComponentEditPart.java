...
public class ComponentEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new jacroidEMF.diagram.edit.policies.ComponentItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof jacroidEMF.diagram.edit.parts.ComponentNameTypeEditPart) {
			((jacroidEMF.diagram.edit.parts.ComponentNameTypeEditPart) childEditPart)
