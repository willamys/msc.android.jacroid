 ...
 * @generated
 */
public class EnumerateNameTypeDataEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public EnumerateNameTypeDataEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new jacroidEMF.diagram.edit.policies.JacroidEMFTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = jacroidEMF.diagram.providers.JacroidEMFParserProvider
					.getParser(
							jacroidEMF.diagram.providers.JacroidEMFElementTypes.Enumerate_2004,
							getParserElement(),
							jacroidEMF.diagram.part.JacroidEMFVisualIDRegistry
									.getType(jacroidEMF.diagram.edit.parts.EnumerateNameTypeDataEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					jacroidEMF.diagram.edit.parts.JacroidEMFEditPartFactory
