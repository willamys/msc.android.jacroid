 ...
 * @generated
 */
public class ProjetoEditPart extends DiagramEditPart {

	/**
	 * @generated
	 */
	public final static String MODEL_ID = "JacroidEMF"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	public ProjetoEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new jacroidEMF.diagram.edit.policies.ProjetoItemSemanticEditPolicy());
		installEditPolicy(
				EditPolicyRoles.CANONICAL_ROLE,
				new jacroidEMF.diagram.edit.policies.ProjetoCanonicalEditPolicy());
		installEditPolicy(
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new jacroidEMF.diagram.edit.commands.JacroidEMFCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
