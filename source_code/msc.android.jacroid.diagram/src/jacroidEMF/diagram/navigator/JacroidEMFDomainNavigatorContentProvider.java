 ...
 * @generated
 */
public class JacroidEMFDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public JacroidEMFDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof jacroidEMF.diagram.navigator.JacroidEMFDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((jacroidEMF.diagram.navigator.JacroidEMFDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new jacroidEMF.diagram.navigator.JacroidEMFDomainNavigatorItem(
